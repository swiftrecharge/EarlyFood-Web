			...
			<article class="row" id="article2">
				...
				<div id="store" class="article2_all">
					<div id="android" class="article2_sub">
						<center><a href="#" id="androidDownload"><img src="homepage/images/icon-google.png"></a></center>
					</div>
					<div id="ios" class="article2_sub">
						<center><a href="#" id="iosDownload"><img src="homepage/images/icon-ios.png"></a></center>
					</div>
				</div>
			</article>
		</section>
