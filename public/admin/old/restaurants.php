...
<?php connect_to_db(); ?>
<div class="col-lg-6 col-md-7 col-sm-8" ><!-- col1 -->
		<div id="main">
				<div id="order_title" class="jumbotron">
					<a href="#"><img class="main" src="images/logo.png" alt="" /></a><span><em>Registered Restaurants</em></span>
				</div>
				<form action="restaurants.php" method="post">
					<div class="commands_block row"> <!-- row2 -->
						<div class="command">
					...
					<div class="commands_block row"><!-- row3 -->
						<div class="command">
